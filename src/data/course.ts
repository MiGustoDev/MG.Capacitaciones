...
export const COURSE_MEDICINA: Course = {
  id: 'medicina',
  title: 'Medicina, RCP y Emergencias',
  subtitle: 'Capacitación Médica e Intervención Crítica en Planta',
  company: 'Mi Gusto - Servicio Médico',
  totalModules: 5,
  objectives: [
    'Actuar con serenidad, bioseguridad y protocolo PAS ante emergencias médicas y siniestros',
    'Dominar maniobras de RCP en adultos, niños y lactantes, maniobra de Heimlich y uso del DEA',
    'Conocer primeros auxilios ante quemaduras, intoxicaciones, heridas, convulsiones y uso de extintores',
  ],
  passScore: 0,
  questions: [],
  freeNavigation: true,
  modules: [
    {
      ...
      number: 1,
      title: 'Principios de Primeros Auxilios',
      description: 'Conducta PAS (Proteger, Avisar, Socorrer), bioseguridad y evaluación primaria.',
      icon: '🚑',
      color: 'bg-red-500',
      colorHex: '#ef4444',
      lessons: [
        {
          id: 'pas-bioseguridad',
          title: 'Conducta PAS y Bioseguridad',
          type: 'bullet-list',
          content: {
            title: 'Protocolo Internacional PAS y Bioseguridad',
            subtitle: 'Proteger · Avisar · Socorrer',
            description: 'Ante cualquier emergencia en planta o vía pública, la primera regla es no transformarse en una segunda víctima.',
            badge: 'Principios Fundamentales',
            items: [
              { icon: '🛡️', text: '1. PROTEGER (Escena Segura): Evaluar riesgos antes de acercarse (cables expuestos, vapores tóxicos, maquinaria en movimiento, tráfico). Usar siempre guantes desechables.' },
              { icon: '📞', text: '2. AVISAR (Llamado Médico): Activar el servicio de emergencia de la planta o llamar a la ambulancia (107 / 911). Dar ubicación exacta y estado del paciente.' },
              { icon: '🤝', text: '3. SOCORRER (Atención Inicial): Brindar asistencia básica con serenidad sin sobrepasar los conocimientos. Mantener la calma de la víctima.' },
              { icon: '🛑', text: 'REGLA DE ORO MÉDICA: Podés hacer MUCHO con MUY POCO. No diagnostiques, no mediques y nunca dejes sola a la víctima.' },
            ],
            tagline: 'Mi Gusto · Servicio Médico',
          },
        },
        {
          id: 'evaluacion-inicial',
          title: 'Evaluación Inicial en 10 Segundos',
          type: 'alert',
          content: {
            title: 'Evaluación Primaria de la Víctima (MES)',
            subtitle: 'Mirar · Escuchar · Sentir',
            description: 'En una persona tendida o desmayada se debe determinar su estado en menos de 10 segundos.',
            badge: 'Evaluación de Signos Vitales',
            highlight: 'PASO 1: Tocar firmemente los hombros y preguntar con voz fuerte: "¿Me escuchás? ¿Estás bien?"\nPASO 2: Observar si el tórax se eleva (Mirar, Escuchar, Sentir la respiración por 5 a 10 segundos).\nSI NO RESPONDE NI RESPIRA: Activar el protocolo de Paro Cardiorrespiratorio e iniciar RCP inmediatamente.',
            highlightVariant: 'danger',
            items: [
              { icon: '🗣️', text: 'Responde y habla: La víctima tiene vía aérea permeable y pulso. Tranquilizarla y mantenerla abrigada.' },
              { icon: '🫁', text: 'Respiración agónica (Gasping): Si hace jadeos o ruidos extraños NO es respiración normal, se debe tratar como paro cardíaco.' },
            ],
            tagline: 'Mi Gusto · Servicio Médico',
          },
        },
    ...
    },
    {
      id: 'rcp',
      number: 2,
      title: 'RCP y Desfibrilador (DEA)',
      description: 'Reanimación Cardiopulmonar en adultos, niños, lactantes y manejo seguro del DEA.',
      icon: '🫀',
      color: 'bg-red-500',
      colorHex: '#ef4444',
      lessons: [
        {
          id: 'rcp-adultos',
          title: 'RCP en Adultos (Técnica Paso a Paso)',
          type: 'steps',
          content: {
            title: 'Reanimación Cardiopulmonar (RCP) en Adultos',
            subtitle: 'Compresiones torácicas ininterrumpidas de alta calidad (100 a 120 cpm)',
            description: 'La RCP mantiene el flujo sanguíneo oxigenado hacia el cerebro y el corazón hasta que llegue el desfibrilador o auxilio médico.',
            badge: 'Soporte Vital Básico',
            image: '/diapositivas/medicina/heimlinch/RCP.mp4',
            imageAlt: 'Demostración de RCP en Adultos',
            imageFit: 'contain',
            stepsTitle: 'Pasos Fundamentales de RCP',
            steps: [
              { number: 1, letter: '1', title: '1. Posicionamiento Rígido', description: 'Acostar a la víctima BOCA ARRIBA sobre una superficie firme y plana. Arrodillarse al costado del tórax.' },
              { number: 2, letter: '2', title: '2. Ubicación de Manos', description: 'Colocar el TALÓN DE UNA MANO en el centro del pecho (mitad inferior del esternón). Entrelazar los dedos de la otra mano por encima.' },
              { number: 3, letter: '3', title: '3. Postura Corporal Correcta', description: 'Mantener los BRAZOS RECTOS sin doblar codos y los hombros alineados sobre el centro del pecho. Usar el peso del torso para comprimir.' },
              { number: 4, letter: '4', title: '4. Profundidad y Ritmo (100 - 120 cpm)', description: 'Comprimir con 5 a 6 cm de profundidad a ritmo rápido (100-120 cpm). Permitir la EXPANSIÓN COMPLETA del tórax entre compresiones.' },
            ],
            tagline: 'Mi Gusto · Servicio Médico',
          },
        },
        {
          id: 'rcp-ninos-lactantes',
          title: 'RCP en Niños y Lactantes',
          type: 'compare',
          content: {
            title: 'Diferencias Técnicas de RCP por Edad',
            subtitle: 'Adaptación de presión corporal y extremidades',
            description: 'En pediatría y neonatología la causa más frecuente de paro es respiratoria (asfixia o ahogamiento).',
            badge: 'Pediatría y Lactantes',
            compareColumns: [
              {
                label: 'RCP en Niños (1 a 8 Años)',
                variant: 'correct',
                items: [
                  'Utilizar 1 SOLA MANO (talón de la mano) en el centro del pecho.',
                  'Comprimir aproximadamente 4 a 5 cm de profundidad.',
                  'Frecuencia constante: 100 a 120 compresiones por minuto.',
                  'Si estás solo: Realizar 2 minutos de RCP ANTES de pedir ayuda.',
                ],
              },
              {
                label: 'RCP en Lactantes (0 a 12 Meses)',
                variant: 'correct',
                items: [
                  'Utilizar solo 2 DEDOS (índice y medio) debajo de la línea del pecho.',
                  'Comprimir 3 a 4 cm de profundidad con suave firmeza.',
                  'Frecuencia rápida: 100 a 120 compresiones por minuto.',
                  'Mantener la cabeza ligeramente inclinada en posición neutra.',
                ],
              },
            ],
            tagline: 'Mi Gusto · Servicio Médico',
        ...
        {
          id: 'uso-dea',
          title: 'Operación Segura del DEA',
          type: 'steps',
          content: {
            title: 'Desfibrilador Externo Automático (DEA)',
            subtitle: 'Pasos para desfibrilación segura en planta',
            description: 'El DEA analiza el ritmo cardíaco y administra una descarga eléctrica para revertir la fibrilación ventricular.',
            badge: 'Uso de Tecnología Médica',
            stepsTitle: 'Pasos para el Uso del DEA',
            steps: [
              { number: 1, letter: '1', title: '1. Encendido Inmediato', description: 'Abrir la tapa o presionar el BOTÓN VERDE de encendido. El DEA te guiará con voz clara en español.' },
              { number: 2, letter: '2', title: '2. Colocación de Parches', description: 'Secar el pecho si está húmedo. Pegar un parche DEBAJO DE LA CLAVÍCULA DERECHA y el otro EN EL COSTADO IZQUIERDO.' },
              { number: 3, letter: '3', title: '3. Análisis del Ritmo', description: 'Conectar el cable al DEA. Gritar fuerte: "¡NADIE TOCA A LA VÍCTIMA!" para evitar interferencias.' },
              { number: 4, letter: '4', title: '4. Descarga Eléctrica', description: 'Si indica "Descarga aconsejada", verificar que nadie toque al paciente y presionar el BOTÓN ILUMINADO. Reanudar RCP de inmediato.' },
            ],
            tagline: 'Mi Gusto · Servicio Médico',
          },
        },
    ...
    },
    {
      ...
      description: 'Atención inmediata ante Obstrucción de Vía Aérea por Cuerpo Extraño (OVACE).',
      icon: '🫁',
      color: 'bg-red-500',
      colorHex: '#ef4444',
      lessons: [
        {
          id: 'heimlich-adultos',
          title: 'Heimlich en Adultos',
          type: 'steps',
          content: {
            title: 'Desobstrucción en Adultos y Niños (+1 año)',
            subtitle: 'Compresiones abdominales en forma de "J"',
            description: 'El atragantamiento por alimento u objeto bloquea la tráquea. El tiempo de respuesta es vital para evitar la pérdida de conocimiento.',
            badge: 'Técnica de Salvataje',
            image: '/diapositivas/medicina/heimlinch/Heimlinch.gif',
            imageAlt: 'Demostración animada Maniobra de Heimlich',
            imageFit: 'contain',
            stepsTitle: 'Pasos Clave de la Maniobra',
            steps: [
              { number: 1, letter: '1', title: 'Reconocer Señal de Asfixia', description: 'La persona se lleva las manos al cuello (signo universal de ahogamiento), no puede hablar, toser ni respirar.' },
              { number: 2, letter: '2', title: 'Posición del Rescatador', description: 'Colocarse de pie detrás de la víctima con una pierna entre las de ella (para estabilizarla si pierde el conocimiento) y rodear su cintura.' },
              { number: 3, letter: '3', title: 'Ubicación del Puño', description: 'Cerrar el puño situando el pulgar 2 dedos por encima del ombligo (boca del estómago). Cubrir el puño firmemente con la otra mano.' },
              { number: 4, letter: '4', title: 'Compresiones Rápidas en "J"', description: 'Presionar secamente HACIA ADENTRO Y HACIA ARRIBA (en forma de J). Repetir enérgicamente hasta que expulse el objeto.' },
              { number: 5, letter: '5', title: 'Variación en Embarazadas / Obesos', description: 'Realizar las compresiones sobre el centro del pecho (esternón), similar a la maniobra de RCP.' },
            ],
            tagline: 'Mi Gusto · Servicio Médico',
          },
        },
        {
          id: 'heimlich-bebes',
          title: 'Heimlich en Bebés',
          type: 'steps',
          content: {
            title: 'Desobstrucción de Vía Aérea en Bebés',
            subtitle: 'Secuencia de 5 golpes en la espalda y 5 compresiones torácicas',
            description: 'Jamás realizar compresiones abdominales en lactantes para evitar lesiones en órganos internos.',
            badge: 'Técnica Pediátrica',
            stepsTitle: 'Protocolo para Lactantes (< 1 año)',
            steps: [
              { number: 1, letter: '1', title: 'Boca Abajo sobre el Antebrazo', description: 'Sostener al bebé boca abajo apoyado en tu antebrazo, sujetando su mandíbula firmemente con la mano (cabeza más baja que el cuerpo).' },
              { number: 2, letter: '2', title: '5 Golpes en la Espalda', description: 'Dar 5 golpes firmes con el talón de la otra mano en el centro de la espalda (entre los escápulas/escápulas).' },
              { number: 3, letter: '3', title: 'Girar Boca Arriba', description: 'Girar al bebé con cuidado sobre el otro antebrazo manteniéndolo sujetado.' },
              { number: 4, letter: '4', title: '5 Compresiones Torácicas', description: 'Realizar 5 compresiones torácicas rápidas con 2 dedos en el centro del pecho.' },
              { number: 5, letter: '5', title: 'Repetición Continua', description: 'Repetir la secuencia (5 golpes / 5 compresiones) hasta que expulse el objeto o pierda el conocimiento (en ese caso iniciar RCP).' },
            ],
            tagline: 'Mi Gusto · Servicio Médico',
          },
        },
    ...
    {
      id: 'quemaduras-intoxicaciones',
      number: 4,
      title: 'Quemaduras e Intoxicaciones',
      description: 'Protocolos ante quemaduras, productos químicos, sangrados, caídas y convulsiones.',
      icon: '🧪',
      color: 'bg-red-500',
      colorHex: '#ef4444',
      lessons: [
        {
          id: 'quemaduras-quimicos',
          title: 'Quemaduras y Sustancias Químicas en Planta',
          type: 'compare',
          content: {
            title: 'Primeros Auxilios ante Quemaduras y Químicos',
            subtitle: 'Acciones Correctas vs Errores Graves',
            description: 'En el entorno de cocina y producción, los riesgos térmicos y químicos requieren respuesta inmediata.',
            badge: 'Atención de Lesiones',
            compareColumns: [
              {
                label: 'QUEMADURAS (Calor / Aceite / Vapor)',
                variant: 'correct',
                items: [
                  'Enfriar INMEDIATAMENTE bajo agua corriente limpia por 10 a 15 minutos.',
                  'NO romper las ampollas (protegen contra infecciones).',
                  'NO aplicar dentífrico, tomate, aceite, manteca ni hielo directo.',
                  'Cubrir la zona con gasa estéril o paño limpio y acudir al médico.',
                ],
              },
              {
                label: 'INTOXICACIÓN O CONTACTO CON QUÍMICOS',
                variant: 'correct',
                items: [
                  'Contacto Cutáneo/Ocular: Lavar con agua continua por al menos 15 minutos.',
                  'Ingesta de Químicos: NO PROVOCAR EL VÓMITO (evita volver a quemar el esófago).',
                  'Inhalación de Vapores: Trasladar a la persona al aire libre inmediatamente.',
                  'Guardar el envase y la Ficha de Seguridad del producto para el médico.',
                ],
              },
            ],
            tagline: 'Mi Gusto · Servicio Médico',
        ...
        {
          id: 'hemorragias-golpes',
          title: 'Hemorragias, Cortantes y Traumatismos',
          type: 'bullet-list',
          content: {
            title: 'Manejo de Sangrados y Caídas de Altura',
            subtitle: 'Compresión directa y protección espinal',
            description: 'Guía práctica para responder ante cortes en producción y caídas de personal.',
            badge: 'Traumatología y Hemorragias',
            items: [
              { icon: '🩸', text: 'Hemorragias y Cortes: Colocar una gasa estéril o paño limpio sobre la herida y ejercer COMPRESIÓN DIRECTA constante con la mano por 5 a 10 minutos.' },
              { icon: '🚫', text: 'Torniquetes: Salvo amputación traumática, NO se utilizan torniquetes caseros por riesgo de necrosis.' },
              { icon: '🔪', text: 'Objetos Clavados: NUNCA retirar cuchillos, vidrios o metales incrustados. Fijar el objeto con vendas y trasladar de urgencia.' },
              { icon: '🦴', text: 'Caídas / Golpes en la Cabeza: Dejar a la víctima inmóvil en el piso. NO mover el cuello ni la columna vertebral bajo ninguna circunstancia.' },
              { icon: '🤝', text: 'Contención Emocional: Mantener a la persona abrigada, tranquila y hablándole con voz pausada.' },
            ],
            tagline: 'Mi Gusto · Servicio Médico',
          },
        },
        {
          ...
          type: 'compare',
          content: {
            title: 'Protocolo ante Crisis Convulsivas',
            subtitle: 'Lo que DEBÉS hacer vs Lo que NUNCA debés hacer',
            description: 'Una convulsión genera movimientos involuntarios y pérdida de conocimiento.',
            badge: 'Emergencias Neurológicas',
            compareColumns: [
              {
                label: 'ACCIONES CORRECTAS ✅',
                variant: 'correct',
                items: [
                  'Proteger la cabeza colocando una campera o almohadón debajo.',
                  'Retirar objetos cortantes o duros del alrededor.',
                  'Cronometrar la duración del episodio.',
                  'Al finalizar los temblores, colocar en Posición Lateral de Seguridad (PLS).',
                ],
              },
              {
                label: 'PRÁCTICAS PROHIBIDAS ❌',
                variant: 'incorrect',
                items: [
                  'NUNCA meter los dedos ni objetos dentro de la boca.',
                  'NUNCA sujetar a la persona a la fuerza para detener los movimientos.',
                  'NUNCA darle líquidos ni medicamentos por boca mientras convulsiona.',
                ],
              },
            ],
            tagline: 'Mi Gusto · Servicio Médico',
    ...
    },
    {
      id: 'extintor',
      number: 5,
      title: 'Uso del Matafuegos',
      description: 'Manejo correcto de extintores (Regla JAAR) y normas de seguridad en planta.',
      icon: '🧯',
      color: 'bg-red-500',
      colorHex: '#ef4444',
      lessons: [
        {
          id: 'm5-l1',
          title: 'Uso del Extintor (Regla JAAR)',
          type: 'steps',
          content: {
            title: 'Operación del Extintor en 4 Pasos',
            subtitle: 'Regla JAAR · Jalar · Apuntar · Apretar · Realizar el Barrido',
            description: 'En caso de ver fuego controlado (principio de incendio), responder rápidamente con el matafuegos más cercano.',
            badge: 'Servicio Médico & Seguridad',
            image: '/diapositivas/medicina/extintor/extintor.png',
            imageAlt: 'Uso del extintor de incendio',
            imageFit: 'contain',
            stepsTitle: 'Método J A A R',
            steps: [
              { number: 1, letter: 'J', title: 'Jalar el seguro', description: 'Descolgar el extintor, romper el precinto plástico de seguridad y extraer el pasador/traba metálica.' },
              { number: 2, letter: 'A', title: 'Apuntar hacia la base del fuego', description: 'Ubicarse a favor del viento a 2 metros del fuego y apuntar la manguera DIRECTAMENTE a la base de las llamas (no al humo).' },
              { number: 3, letter: 'A', title: 'Apretar la palanca', description: 'Presionar la palanca o gatillo de manera continua para liberar la descarga de polvo o gas extintor.' },
              { number: 4, letter: 'R', title: 'Realizar el barrido', description: 'Mover la manguera de un lado a otro en forma de abanico sobre la base del fuego hasta extinguirlo por completo.' },
            ],
            tagline: 'Mi Gusto · Servicio Médico',
          },
        },
        {
          id: 'm5-l2',
          title: 'Precauciones y Medidas de Seguridad en Planta',
          type: 'bullet-list',
          content: {
            title: 'Información Crítica para el Uso de Extintores',
            subtitle: 'Normas obligatorias de seguridad en fábrica',
            description: 'Detalles fundamentales a tener en cuenta antes, durante y después del uso de un extintor en el sector de producción.',
            badge: 'Seguridad en Planta',
            items: [
              { icon: '📐', text: 'Distancia de Seguridad: Colocarse a una distancia de 2 a 3 metros del fuego. Nunca acercarse demasiado para evitar proyecciones de llamas o material incandescente.' },
              { icon: '💨', text: 'Posición a Favor del Viento/Viento Trasero: Si el principio de fuego ocurre al aire libre o cerca de extractores, operar siempre con el viento a la espalda para protegerse del humo y del calor.' },
              { icon: '🚪', text: 'Asegurar Ruta de Evacuación: Antes de accionar el extintor, verificar tener una vía de escape despejada a las espaldas. Nunca quedar acorralado por las llamas.' },
              { icon: '⚠️', text: 'Manómetro e Inspección Visual: Comprobar que la aguja del manómetro esté en la zona verde (presión correcta) y que el precinto de seguridad no esté roto antes de usarlo.' },
              { icon: '🔔', text: 'Aviso Inmediato Pos-Uso: Una vez utilizado el extintor (incluso si fue solo un disparo corto), reportarlo de inmediato a Seguridad e Higiene para su recarga obligatoria.' },
            ],
            tagline: 'Mi Gusto · Servicio Médico',
          },
        },
